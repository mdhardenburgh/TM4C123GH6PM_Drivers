...
class uDMA : SystemControl
{
    ...
    private:
        ...
        const uint32_t PPDMA_OFFSET = 0x30C;
        const uint32_t SRDMA_OFFSET = 0x50C;
        const uint32_t RCGCDMA_OFFSET = 0x60C;
        const uint32_t SCGCDMA_OFFSET = 0x70C;
        const uint32_t DCGCDMA_OFFSET = 0x80C;
        const uint32_t PRDMA_OFFSET = 0xA0C;

/**********************System Control Register Descriptions********************/

        Register* PPDMA; //0x30C PPDMA RO 0x0000.0001 Micro Direct Memory Access Peripheral Present 293
        Register* SRDMA; //0x50C SRDMA RW 0x0000.0000 Micro Direct Memory Access Software Reset 316
        Register* RCGCDMA; //0x60C RCGCDMA RW 0x0000.0000 Micro Direct Memory Access Run Mode Clock Gating Control 342
        Register* SCGCDMA; //0x70C SCGCDMA RW 0x0000.0000 Micro Direct Memory Access Sleep Mode Clock Gating Control 364
        Register* DCGCDMA; //0x80C DCGCDMA RW 0x0000.0000 Micro Direct Memory Access Deep-Sleep Mode Clock Gating Control 386
        Register* PRDMA; //0xA0C PRDMA RO 0x0000.0000 Micro Direct Memory Access Peripheral Ready 408
