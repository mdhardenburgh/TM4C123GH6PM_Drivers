...
class Adc : SystemControl
{
    ...
    private:
        ...
        const uint32_t PPADC_OFFSET = 0x338;
        const uint32_t SRADC_OFFSET = 0x538;
        const uint32_t RCGCADC_OFFSET = 0x638;
        const uint32_t SCGCADC_OFFSET = 0x738;
        const uint32_t DCGCADC_OFFSET = 0x838;
        const uint32_t PRADC_OFFSET = 0xA38;

/**********************System Control Register Descriptions********************/

        Register* PPADC; //0x338 PPADC RO 0x0000.0003 Analog-to-Digital Converter Peripheral Present 303
        Register* SRADC; //0x538 SRADC RW 0x0000.0000 Analog-to-Digital Converter Software Reset 327
        Register* RCGCADC; //0x638 RCGCADC RW 0x0000.0000 Analog-to-Digital Converter Run Mode Clock Gating Control 352
        Register* SCGCADC; //0x738 SCGCADC RW 0x0000.0000 Analog-to-Digital Converter Sleep Mode Clock Gating Control 374
        Register* DCGCADC; //0x838 DCGCADC RW 0x0000.0000 Analog-to-Digital Converter Deep-Sleep Mode Clock Gating Control 396
        Register* PRADC; //0xA38 PRADC RO 0x0000.0000 Analog-to-Digital Converter Peripheral Ready 418
