...
/**************************System Control BitFields****************************/
        ...
        bitField PPEEPROM_P0{0, 1, RO}; //EEPROM Module Present
        bitField SREEPROM_R0{0, 1, RW}; //EEPROM Module Software Reset
        bitField RCGCEEPROM_R0{0, 1, RW}; //EEPROM Module Run Mode Clock Gating Control
        bitField SCGCEEPROM_S0{0, 1, RW}; //EEPROM Module Sleep Mode Clock Gating Control
        bitField DCGCEEPROM_D0{0, 1, RW}; //EEPROM Module Deep-Sleep Mode Clock Gating Control
        bitField PREEPROM_R0{0, 1, RO}; //EEPROM Module Peripheral Ready
